...
var style_IndicedeVegetacion_2 = function(feature, resolution){
    ...
    if (value >= 0.204012 && value <= 0.316490) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.316490 && value <= 0.428967) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.428967 && value <= 0.541445) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.541445 && value <= 0.653923) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.653923 && value <= 0.766401) {
            style = [ new ol.style.Style({
